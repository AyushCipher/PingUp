...
const Login = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row relative">
      ...
      {/* Left-side : Branding */}
      <div className="flex flex-col items-start justify-between p-6 md:p-10 lg:pl-32 xl:pl-40 flex-[0.9]">
      ...
      <div className="flex-[1.1] flex items-center justify-start md:pl-10 lg:pl-16 xl:pl-20 p-6 sm:p-10">
        <SignIn />
      </div>
    </div>
  )

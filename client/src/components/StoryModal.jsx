  ...
  return (
    <div className="fixed inset-0 z-[110] min-h-screen bg-black/80 backdrop-blur flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        {/* Story Preview */}
        <div
          className="rounded-lg h-96 flex items-center justify-center relative transition-colors duration-300"
        ...
        <div className="flex justify-center mt-4 gap-3">
          {bgColors.map((color) => (
            <button
              key={color}
              className="w-6 h-6 rounded-full ring-2 ring-white/50 cursor-pointer"
        ...
        <div className="flex gap-2 mt-4">
            ...
            <button
                ...
                className={`flex-1 flex cursor-pointer items-center justify-center gap-2 p-2 rounded

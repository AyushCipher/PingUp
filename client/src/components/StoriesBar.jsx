      ...
      <div className="flex gap-4 pb-5">
        ...
        {stories.map((story, index) => (
          <div onClick={() => setViewStory(story)}
            ...
            cursor-pointer hover:shadow-lg transition-all duration-200 bg-gradient-to-b from-indigo-500 to-purple-600
                    ...
                    <div className='absolute inset-0 z-1 rounded-lg bg-black overflow-hidden'>
                        {
                            ...
                            :
                            <video src={story.meida_url} className='h-full w-full object-cover hover:scale-110 transition
                            duraion-500 opacity-70 hover:opacity-80'></video>
                        }
                    </div>
                )
            }

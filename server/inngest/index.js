...
// Ingest function to send a reminder when a new connection request is added
        ...
        await step.run('send-new-connection-request-mail', async () => {
            ...
            await step.run('send-connection-request-reminder', async () => {
                ...
                if(connection.status === "accepted") {
                    return {message: "Aready Accepted"}
                }
...
// Inngest function to delete a story after 24 hrs
...
const sendNotificationOfUnseenMessages = inngest.createFunction(
    ...
    {cron: "TZ=America/New-York 0 9 * * *"}, // Every day at 9 a.m.
    async ({ event, step }) => {
